        ...
        <div>
            <Link to={`/video/${video?.videoId}`}>
                <div className='flex mb-3'>
                    ...
                    <div className='relative  h-24 md:h-20 xl:24 w-40 min-w-[168px] lg:w-32 lg:min-w-[128px] xl:w-40 xl:min-w-[168px]  rounded-xl hover:rounded-none duration-200 overflow-hidden'>
